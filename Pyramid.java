...
public class Pyramid extends JFrame {
	...
	public Pyramid() {
		...
		ground = new JLabel(new ImageIcon(Pyramid.class.getResource("/resources/ground.png")));
		add(ground);
		...
		/* PIPE IT UP */
		pipe = new JLabel(new ImageIcon(Pyramid.class.getResource("/resources/pipe.png")));
		add(pipe);
	...
	public JLabel[] setUpBricks() {
		...
		for (int i = 0; i < bricks.length; i++) {
			...
			bricks[i] = new JLabel(new ImageIcon(Pyramid.class.getResource("/resources/brick.png")));
			add(bricks[i]);
